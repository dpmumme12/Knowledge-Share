...
const articlefeed_api_url = JSON.parse(get('#articlefeed_api_url').textContent);
...
async function get_newsfeed(page, form_data=null) {
    ...
    var response = await fetch(articlefeed_api_url + `?page=${page}&` + search_params);
...
function appendArticle(id, img, title, content, date, username, full_name) {
    ...
    <div class="col-md-12 me-auto">
            <div class="profile-card pb-2">
                ...
                <a href="/social/dashboard/${username}" class="text-decoration-none text-dark">
