...
function edit_article(event) {
  ...
  document.getElementById('ArticleHeaderModal-form').setAttribute('action', `/knowledgebase/kb/article/edit/${id}`)
}
...
function edit_folder(event) {
  ...
  document.getElementById('EditFolderModal-form').setAttribute('action', `/knowledgebase/folder/edit/${id}`)
